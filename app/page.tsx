...
export default function Home() {
  ...
  const [playerStats, setPlayerStats] = useLocalStorage<PlayerStatsType>(
    "wordGameStats",
    initialPlayerStats
  );
  ...
  const [levelUnlocked, setLevelUnlocked] = useState<DifficultyLevel | null>(
    null
  );
  ...
  const createInitialGameState = useCallback(
    (level: DifficultyLevel = "basic"): GameState => {
  ...
  const wrongLetters = gameState.guessedLetters.filter(
    (letter) => !gameState.currentWord.includes(letter)
  );

  // Calculate current points for display
  const currentPoints =
    gameState.gameStatus === "playing" && currentSession
      ? calculatePoints(
          gameState.currentLevel,
          true,
          gameState.guessedLetters.length,
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center py-16">
            ...
            <p className="text-xl text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Challenge your vocabulary across four difficulty levels. Earn
              points, unlock achievements, and compete with friends in this
              modern word-guessing experience.
            </p>

            <Button
              size="lg"
              onClick={() => setShowAuth(true)}
              className="mb-12 px-12 py-6 text-xl bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 shadow-2xl"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
              <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-slate-400 text-sm">
                    Four challenging levels from Basic to Professional
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-slate-400 text-sm">
                    Earn points and unlock new difficulty levels
                  </p>
                </CardContent>
              </Card>
            </div>
              ...
              <Card className="max-w-lg mx-auto bg-gradient-to-r from-purple-900/50 to-pink-900/50 border-2 border-purple-500/30 backdrop-blur-sm">
                <CardContent className="p-8">
                  <div className="flex items-center justify-center gap-3 mb-4">
                    ...
                    <Heart className="w-6 h-6 text-red-800 animate-pulse" />
                  </div>
          ...
          <div className="flex justify-between items-start mb-8">
            <div className="text-center flex-1">
              ...
              <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
                Ready to challenge your vocabulary? Choose your difficulty and
